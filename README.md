# PDL: PROT PPU ECC injection

This code example demonstrates how to perform the error injection onto error correcting code (ECC) of peripheral protection unit (PPU).

[View this README on GitHub.](https://github.com/Infineon/mtb-example-ce240952-prot-ppu-ecc-injection)

[Provide feedback on this code example.](https://yourvoice.infineon.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
The following example clones the "[mtb-example-ce240952-prot-ppu-ecc-injection](https://github.com/Infineon/mtb-example-ce240952-prot-ppu-ecc-injection)" application with the desired name "ProtPpuEccInjection" configured for the *KIT_T2G_C-2D-6M_LITE* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_T2G_C-2D-6M_LITE --app-id mtb-example-ce240952-prot-ppu-ecc-injection --user-app-name ProtPpuEccInjection --target-dir "C:/mtb_projects"
   ```
...
4. After programming, the application starts automatically. Confirm that "PPU ECC Error Injection example" is displayed on the UART terminal.
...
This code example shows how to generate a PPU ECC error injection message in the terminal software via UART. **Table 1** shows the resources used for the same.
...
GPIO          | CYBSP_USER_LED1        | User LED to show visual output 
...
Resources  | Links
-----------|----------------------------------
Application notes  | [AN235305](https://www.infineon.com/assets/row/public/documents/10/42/infineon-an235305-getting-started-with-traveo-t2g-family-mcus-in-modustoolbox-applicationnotes-en.pdf) – Getting started with TRAVEO&trade; T2G family MCUs in ModusToolbox&trade;　<br> [AN220193](https://www.infineon.com/row/public/documents/10/42/infineon-an220118---gpio-usage-setup-in-traveo-t2g-family-applicationnotes-en.pdf) – GPIO usage setup in TRAVEO&trade; T2G family　<br> [AN219843](https://www.infineon.com/row/public/documents/10/42/infineon-an219843---protection-configuration-in-traveo-tm-t2g-applicationnotes-en.pdf) – Protection configuration in TRAVEO&trade; T2G
...
Document title: *CE240952 – PDL: PROT PPU ECC injection* 
