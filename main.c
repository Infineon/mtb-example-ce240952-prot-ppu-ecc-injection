...
int main(void)
{
    ...
    Cy_SysFault_SetMaskByIdx(FAULT_STRUCT0, (cy_en_SysFault_source_t) PERI_PERI_C_ECC);
    Cy_SysFault_SetMaskByIdx(FAULT_STRUCT0, (cy_en_SysFault_source_t) PERI_PERI_NC_ECC);
    ...
    *att.pu32[0] = TEST_ATTRIBUTE.att[0];
    ...
    if (faultSource == (cy_en_SysFault_source_t) PERI_PERI_C_ECC)
    {
        printf("-->success\r\n");
    }
    else
    ...
    *att.pu32[0] = TEST_ATTRIBUTE.att[0];
    ...
    if (faultSource == (cy_en_SysFault_source_t) PERI_PERI_NC_ECC)
    {
        printf("-->success\r\n");
    }
    else
